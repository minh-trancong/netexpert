...
const WelcomeBack = ({ handleSubmit }: { handleSubmit: (e: React.FormEvent<HTMLFormElement>) => void }) => {
  ...
  return (
    <form
      className='flex flex-col items-start gap-10 w-5/6 pr-[180px] max-md:pr-[120px] justify-center'
      onSubmit={(e) => {
        e.preventDefault();
    ...
    >
      <div className='flex flex-col items-start'>
        <p className='text-h2 font-bold text-typography-light-title'>Welcome Back!</p>
        <p className='text-extra-small font-medium text-typography-light-body opacity-80'>Login to continue</p>
      </div>
      <div className='flex flex-col items-start gap-4 w-full'>
        <div className='flex flex-col flex-start gap-[10px] w-full'>
          <div className='text-extra-small font-bold text-typography-light-body'>Username</div>
          <label className='w-full h-11'>
            <div className='flex w-full h-full py-[10px] pl-4 pr-20 justify-start items-center gap-[10px] flex-shrink-0 rounded-2xl bg-neutral-7'>
              ...
              <input
                name='username'
                className='text-extra-small font-semibold opacity-70 text-neutral-5'
        ...
        <div className='flex flex-col flex-start gap-[10px] w-full'>
          <div className='text-extra-small font-bold text-typography-light-body'>Password</div>
          <label className='w-full h-11'>
            <div className='flex w-full h-full py-[10px] pl-4 pr-20 justify-start items-center gap-[10px] flex-shrink-0 rounded-2xl bg-neutral-7'>
        ...
        <div className='w-full flex justify-between items-center gap-4'>
          <label className='flex items-center gap-1 group'>
            ...
            <p className='text-extra-small font-semibold text-neutral-5'>Keep me logged in</p>
          </label>
          <div className='flex items-start gap-1'>
            <p className='text-extra-small font-semibold text-neutral-5'>Forgot password?</p>
          </div>
        </div>
        <div className={`w-full flex justify-between gap-2 items-center font-semibold ${submitOk ? 'hidden' : 'visible'}`}>
          <p className='text-extra-small text-system-error-300'>Incorrect username or password. Don’t have an account?</p>
          <p className='text-extra-small text-neutral-5'>Sign up?</p>
        </div>
      </div>
